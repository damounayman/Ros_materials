...
bool unit_8_services_custom_msgs__srv__my_custom_service_message__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unit_8_services_custom_msgs.srv._my_custom_service_message.MyCustomServiceMessage_Request", full_classname_dest, 89) == 0);
  }
  unit_8_services_custom_msgs__srv__MyCustomServiceMessage_Request * ros_message = _ros_message;
  {  // radius
...
PyObject * unit_8_services_custom_msgs__srv__my_custom_service_message__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unit_8_services_custom_msgs.srv._my_custom_service_message");
...
ROSIDL_GENERATOR_C_EXPORT
bool unit_8_services_custom_msgs__srv__my_custom_service_message__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unit_8_services_custom_msgs.srv._my_custom_service_message.MyCustomServiceMessage_Response", full_classname_dest, 90) == 0);
  }
  unit_8_services_custom_msgs__srv__MyCustomServiceMessage_Response * ros_message = _ros_message;
  {  // success
